...
#
# Generated by: Frederik Hjorslev Poulsen
#
...
@{
    ...
    GUID              = '1043b347-925c-4b8b-9cd9-075bc9f9a153'
    ...
    FunctionsToExport = @('Find-SteamAppID', 'Get-SteamServerInfo', 'Install-SteamCMD', 'Update-SteamApp', 'Update-SteamServer', 'Update-SteamWorkshopMods')
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            LicenseUri   = 'https://github.com/hjorslev/SteamPS/blob/master/LICENSE.md'
